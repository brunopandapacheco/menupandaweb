...
import { Search, Heart, Phone, Clock, Star, ExternalLink } from 'lucide-react'
...
const Preview = () => {
  ...
  return (
    <div className="space-y-4">
      {/* Botão para acessar cardápio público */}
      <Card>
        <CardContent className="p-4">
          <div className="flex items-center justify-between">
            <div>
              <h3 className="font-semibold">Cardápio Público</h3>
              <p className="text-sm text-gray-600">
                URL: /cardapio/{designSettings?.slug || 'definir-slug'}
              </p>
            </div>
            <Button onClick={openCardapioPublico} disabled={!designSettings?.slug}>
